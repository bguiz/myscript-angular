...
(function MyscriptWritingSetup() {
  ...
  if (typeof define === 'function' && define.amd) define(function() { return MyscriptWriting; });
  else if (typeof module !== 'undefined') module.exports = MyscriptWriting;
  else if (typeof self !== 'undefined') self.MyscriptWriting = MyscriptWriting;
  else window.MyscriptWriting = MyscriptWriting;
