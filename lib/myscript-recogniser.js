...
(function() {
  ...
  if (typeof define === 'function' && define.amd) define(function() { return MyscriptRecogniser; });
  else if (typeof module !== 'undefined') module.exports = MyscriptRecogniser;
  else if (typeof self !== 'undefined') self.MyscriptRecogniser = MyscriptRecogniser;
  else window.MyscriptRecogniser = MyscriptRecogniser;
